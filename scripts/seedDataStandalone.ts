...
async function seedDatabase() {
  try {
    ...
    console.log('\nSummary:');
    console.log(`- ${insertedSymptoms.length} symptoms across different categories`);
    console.log(`- ${insertedFaults.length} common car faults`);
    console.log(`- ${insertedSolutions.length} repair solutions`);
    console.log(`- ${insertedRules.length} diagnostic rules`);
